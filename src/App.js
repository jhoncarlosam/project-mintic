...
function App() {
  ...
  const fetchCharacters = async (url) => {
    ...
    let raw = await axios.get("https://sea-turtle-app-c7hg6.ondigitalocean.app/api/images", {
      headers: {
        'access-token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c3VhcmlvIjoia2V2aW4iLCJjb21vZGluIjoiMzExMyIsImlhdCI6MTY2Mjg0MTcwMSwiZXhwIjoxNjYyODUyNTAxfQ.QgJ9R3V5FG1eytRxLhpA3-Xgv6Pkfk7IRVuKJVg_Muw'
      }
    })
